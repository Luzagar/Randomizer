                ...
                switch (stageID)
                {
                    ...
                    case stage::StageIDs::Faron_Woods_Interiors:
                    {
                        if ((roomId == 5) || (roomId == 6) || (roomId == 11)) // North Faron or Mist Area
                        {
                            ...
                            if (condition)
                            {
                                chosenLayer = rando::gRandomizer->getSeedPtr()->isLockedLWEnabled() && roomId == 6 ? stage::FaronStateIDs::Faron_Snowpeak_Completed : stage::FaronStateIDs::Faron_MDH_Completed;            
                            }
                            else
                            {
